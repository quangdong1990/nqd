...
def fakeEmail():
  ...
  Domain = input(" \033[1;34m➻❥ Nhập Domain(vd: webmail.co.za) : ")
...
def checkyahoo():
  ...
  try:
    ...
    yahoo_die = input(" \033[1;34m➻❥ Nhập File Lưu Yahoo Die(ex: die.txt) : ")
    yahoo_live = input(" \033[1;34m➻❥ Nhập File Lưu Yahoo Live(ex: live.txt) : ")
  except:
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m➻❥ |\033[1;37mThắng\033[1;32m|Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m➻❥ |\033[1;37mThắng\033[1;31m|Live| " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;34m[ FB:Nguyễn Quang Đông  ]')
  print ('')
  try:
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;32m➻❥ |\033[1;37mĐÔNG\033[1;32m| Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;31m➻❥ |\033[1;37mĐÔNG\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
        ...
        \033[1;36m░▓▓▓▓▓▓▓▓▓▓▓▓██▓▓▓▓▓▓▓▓◤     \033[1;91m  
                  ...
                  \033[0;33m➻❥ Tool By :Nguyễn Quang Đông
                  \033[1;31m➻❥ Donate: Momo: 0346677686
...
def process_menu():
  menu = """
                ...
                \033[1;31m[-----------------------------]
                      ...
                      \033[1;32m2. Tool Check Yahoo.
                      \033[1;33m3. Tool Check Lk Facebook.
                      \033[1;34m4. Thoát Tool.
                \033[1;31m[-----------------------------]
...
"""
  ...
  if choice_user == '4':
    ...
    print (" Bye !.")
    quit()
  if choice_user != '1' or '2' or '3' or '4':
    process_menu()
  if choice_user == '':
    process_menu()
logo() 
